...
$.navTab = {
	config: {box$:'#nav-tab', items$:'#nav-tab > .tab-bar > [tabid]', contents$:'#nav-tab > .tab-panel > .panel-item',
		activeClass:'active', cachedClass:'cached', openIndex:-1},
	$box: null,
	_currentIndex: 0,
	...
	load: function(args){
		...
		$.ajax({
			type:op.type, url:op.url, data: op.data, success:function(html){
